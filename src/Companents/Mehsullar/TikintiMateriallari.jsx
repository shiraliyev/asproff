...
import DataTikintiMateriallari from "../../Data/DataTikintiMateriallari";


function TikintiMateriallari() {
        ...
        <div className="designmain">
          <div className="designmainsec1">
            ...
            <div className="profbetonxidmetler11" ref={(el) => blocksRef.current.push(el)}>
              ...
              >
                {DataTikintiMateriallari.map((slide) => (
...
export default TikintiMateriallari;
